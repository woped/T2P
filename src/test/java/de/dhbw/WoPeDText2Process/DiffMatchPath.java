...
public class DiffMatchPath {
   ...
   * @return Linked List of Diff objects.
   */
  private LinkedList<Diff> diff_main(
   ...
   * @return Linked List of Diff objects.
   */
  private LinkedList<Diff> diff_compute(
      String text1, String text2, boolean checklines, long deadline) {
  ...
  private String diff_linesToCharsMunge(
      String text, List<String> lineArray, Map<String, Integer> lineHash, int maxLines) {
    int lineStart = 0;
    int lineEnd = -1;
    String line;
  ...
  /**
   * loc is a location in text1, compute and return the equivalent location in text2. e.g. "The cat"
