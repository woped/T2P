...
public class UTANDJoin extends T2PUnitTest {
  ...
  private String exspectedPNML =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
          ...
          + " id=\"t1\""
          + " type=\"102\"/><time>0</time><timeUnit>1</timeUnit><orientation>3</orientation></toolspecific></transition>\n"
          + "<arc id=\"a1\" source=\"t1_op_1\""
  ...
  public void evaluateANDJoin() {
    ...
    assertEquals(
        "AND Join did not create exspected PNML.",
        true,
