...
public class ReferenceChooserRestriction {
   ...
   * @param returnName Defines whether the name of the selected element or the id should be
   *     returned.
   */
  public ReferenceChooserRestriction(
      List<String> stereotypeRestrictions, List<Class> nodeTypeRestrictions) {
