...
public abstract class ProcessUtils {
  ...
  public static void writeProperties(
      Document xmlDoc, Element nodeToAddTo, HashMap<String, String> props) {
  ...
  /**
   * uses the movToFront to arrange the nodes in a non-overlapping manner. This is necessary, as the
   * nodes in the workflow.xml can in an arbitrary ordering.
   */
