...
import de.dhbw.text2process.models.bpmn.epc.File;
import de.dhbw.text2process.models.bpmn.epc.Function;
import de.dhbw.text2process.models.bpmn.epc.OrgCollection;
import de.dhbw.text2process.models.bpmn.epc.Organisation;
import de.dhbw.text2process.models.bpmn.epc.OrganisationCluster;
...
public class EPCModelBuilder extends ProcessModelBuilder {
  ...
  public File createFile(Action targetAc, String doName, boolean arriving) {
      ...
      if (!(a.getObject() == null)) { // otherwise addSpecifiers already did the work!
        for (Specifier sp : a.getSpecifiers(SpecifierType.PP)) {
          if ((sp.getName().startsWith("to")
              ...
              && !(SearchUtils.startsWithAny(sp.getPhrase(), Constants.f_parallelIndicators))) {
            _b.append(' ');
