...
public class Configuration {
  ...
  /**
   * @ !not! deprecated This method should not be used, since the direct access to the properties is
   * encapsulated via the Configuration singleton! - yes but this will create dependencies to the
   * Configuration class which we do not want e.g. when we transfer the layouter classes to the IS
   *
   * @return
   */
  ...
  /** Reads the configuration from a file. All default initializations are done here! */
