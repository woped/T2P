...
public abstract class ProcessModel implements Cloneable, Serializable {
  ...
  public static final String VALUE_XSI_SCHEMALOCATION =
      "http://frapu.net/xsd/ProcessEditor http://frapu.net/xsd/ProcessEditor.xsd";
  ...
  /**
   * Returns a single string describing the kind of model this ProcessModel supports.
   *
   * @return
   */
  ...
  /**
   * Creates a deep-copy of this ProcessModel, including all edges and nodes, but NOT listeners AND
   * only reference to transient properties.
   *
   * @return
   */
  @Override
  ...
  /**
   * Returns the ProcessNode(s) of the model that have the given name. More than one node is
   * potentially returned since multiple nodes can have the same name. Returns an empty List if no
   * node was found
   *
   * @param id
   * @return
  ...
  /**
   * Removes a ProcessNode from the ProcessModel (care of Edge handling required).
   *
   * @param node
   */
  ...
  /**
   * Returns all ProcessObjects (combination of Nodes and Edges) in this model.
   *
   * @return
   */
  ...
  /**
   * Returns the Cluster where the ProcessNode is contained, <b>null</b> if not in any Cluster.
   *
   * @param node
   * @return
   */
  ...
  /**
   * Returns the list of supported node classes for this model. This method needs to be implemented.
   *
   * @return
   */
  ...
  /**
   * Returns the list of supported edge classes for this model. This method needs to be implemented.
   *
   * @return
   */
  ...
  /**
   * Moves the given ProcessNode n after the ProcessNode baseNode; i.e. it is drawn later. If n is a
   * Cluster, it is processed recursivly.
   *
   * @param n
   * @param baseNode
   */
  ...
  /**
   * Moves the given ProcessNode to the start of the NodeList; i.e. it should be drawn first.
   *
   * @param n
   */
  ...
  /**
   * Moves the given ProcessNode to the end of the NodeList; i.e. it should be drawn last.
   *
   * @param n
   */
   ...
   *
   * @return True If the model has an URI to a server False if it is a local model
   */
  ...
  public void substitute(
      ProcessObject original, ProcessObject substituteBy, boolean onlyUpdateEnvironment) {
  ...
  /**
   * This method returns the top level nodes of this model (i.e. all that are not contained in a
   * Cluster)
   */
  ...
  /**
   * This method returns a list of all currently vissible nodes, i.e. excluding all nodes that are
   * inside collapsed clusters (recursivly).
   */
