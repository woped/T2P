...
/** Simple Data structure, based on the Stanford sentence. Adds a unique ID to enable tracing */
public class T2PSentence extends Sentence<Word> {
   ...
   *
   * @param w A Collection (interpreted as ordered) to make the sentence out of.
   */
  ...
  /**
   * sets the grammatical structure containing the stanford dependencies
   *
   * @param gs
   */
