...
/**
 * The super-structure which holds all elements which were extracted during the transformation phase
 */
public class WorldModel {
  ...
  public void addAction(Action a) {
    ...
    if (a.getXcomp() != null) addAllElementsInSpecifiers(a.getXcomp());
  }
  ...
  /**
   * an action which e.g. was merged into another one can be removed from the system
   *
   * @param me
   */
