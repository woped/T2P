...
public class ANDSplit extends PetrinetGateway {
  ...
  public ANDSplit(
      String text, boolean hasResource, String originID, PetrinetElementBuilder elementBuilder) {
    super(elementBuilder);
    this.originID = originID;
    split =
        elementBuilder.createTransition(
            text, hasResource, true, originID); // new Transition(text,hasResource,true,originID);
