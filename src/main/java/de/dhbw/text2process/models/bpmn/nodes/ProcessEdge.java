...
public abstract class ProcessEdge extends ProcessObject {
  ...
  public static ProcessEdge newInstanceFromSerialization(
      Node XMLnode, HashMap<String, ProcessNode> nodesInModel)
  ...
  /**
   * Returns if this edge supports docking (might be overwritten by subclasses).
   *
   * @return
   */
  ...
  /** resets the target docking point offset and returns to the usage of automatic determination */
  ...
  /**
   * Determines whether the source arrow should be outlined or not. Might be overwritten by
   * subclasses.
   *
   * @return
   */
  ...
  /**
   * Determines whether the target arrow should be outlined or not. Might be overwritten by
   * subclasses.
   *
   * @return
   */
