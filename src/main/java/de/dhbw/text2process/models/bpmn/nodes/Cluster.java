...
public abstract class Cluster extends ProcessNode implements Serializable {
  ...
  /**
   * Returns if this cluster is collapseable. Might be overwritten by subclasses.
   *
   * @return
   */
  ...
  /**
   * Updates the containment set. Usually required after creating a to initialize containments.
   *
   * @param nodes
   */
