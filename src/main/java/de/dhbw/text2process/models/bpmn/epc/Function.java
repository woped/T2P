...
public class Function extends FlowObject {
  ...
  protected void initializeProperties() {
    ...
    //       String[] type = { Activity.LOOP_NONE, Activity.LOOP_STANDARD,
    // Activity.LOOP_MULTI_SEQUENCE, Activity.LOOP_MULTI_PARALLEL };

    //        String[] atype = { "", Activity.TYPE_SEND, Activity.TYPE_RECEIVE,
    // Activity.TYPE_SERVICE,
