...
public abstract class ProcessObject extends SerializableProcessObject implements Serializable {
  ...
  /**
   * Tests if two ProcessObjects are equal based on their id. If the argument obj is not an instance
   * of ProcessObject, the super function is called.
   *
   * @param obj
   * @return
   */
  ...
  /**
   * Adds a context (ProcessModel) to this ProcessObject. This method must be called each time this
   * object is added to a ProcessModel.
   *
   * @param context
   */
  ...
  /**
   * Removes a context (ProcessModel) from this ProcessObject. This method must be called each time
   * this object is removed from a ProcessModel.
   *
   * @param context
   */
