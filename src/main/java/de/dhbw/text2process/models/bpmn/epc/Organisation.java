...
public class Organisation extends OrganisationCluster implements Linkable {
  ...
  public OrgCollection getSurroundingOrgCollection() {
    if (this.getParent() != null) {
      if (this.getParent() instanceof OrgCollection) return (OrgCollection) this.getParent();
  ...
  /**
   * switches the parent of this Lane. The old and new parent will get notified of the change
   *
   * @param parent
   */
