...
public class StanfordParserFunctionality {
  ...
  public static synchronized StanfordParserFunctionality getInstance() {
    if (instance == null) {
  ...
  // Create Tree by Python-Service. The Service has the latest Core-Nlp Version (Date of Comment:
  // 24.06.2021).
