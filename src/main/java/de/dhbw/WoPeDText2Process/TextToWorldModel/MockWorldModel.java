package de.dhbw.WoPeDText2Process.TextToWorldModel;

import de.dhbw.WoPeDText2Process.TextToWorldModel.transform.DummyAction;
...
public class MockWorldModel {
    ...
    private void generateMockWM() {
        ...
        s1.setSpecifierType(SpecifierType.PP);
        s1.setPhraseType(PhraseType.CORE);
        s1.setHeadWord("to");
        s1.setObject(a[3]);
        ...
        s2.setSpecifierType(SpecifierType.PP);
        s2.setPhraseType(PhraseType.CORE);
        s2.setHeadWord("in");
        s2.setObject(r[4]);
        //s1.setFrameElement(new FrameElement()); //TODO add FrameElement
        ...
        f[0].setDirection(FlowDirection.split);
        f[0].setType(FlowType.sequence);
        ...
        f[1].setDirection(FlowDirection.split);
        f[1].setType(FlowType.choice);
        ...
        f[2].setDirection(FlowDirection.split);
        f[2].setType(FlowType.sequence);
